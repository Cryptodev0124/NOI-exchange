...
import { addWhiteList, cancel, contributeForETH, contributeForToken, disableWhitelist, enableWhitelist, finalize, removeWhiteList, updateInfo, claim, withdraw, emergencyWithdraw } from 'utils/calls'
...
const usePool = (launchpad: `0x${string}`, isNative: boolean) => {
  ...
  const launchpadContractToken = useLaunchpadToken(launchpad)
