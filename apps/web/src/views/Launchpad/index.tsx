...
const Launchpad = ({pool} : {pool: `0x${string}`}) => {
            ...
            <Box p="20px">
              ...
              <Box mt="15px">
                ...
                <Box>
                  ...
                  <Divider />
                  {isTokenReady && isTokenSupplyReady ? <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
                  ...
                  {isDataReady ? <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
                    ...
                    <Text small>{data.liquidity === 0 ? t("Manual listing") : t("CyberGlow DEX")}</Text>
                  </Flex> : <Skeleton width="100%" height={40} />}
                  <Divider />
                  {isDataReady ? <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
        ...
        >
          <StyledAppBody>
            <Box p="20px">
              ...
              {isBuyTokenReady && isDataReady ? <Flex justifyContent="space-between">
                ...
                {data?.presaleType === "standard" ? <Text>{data.hardCap / 10**searchBuyToken.decimals} {searchBuyToken.symbol}</Text>
              ...
              {isDataReady && userDataLoaded && data.userData ? <Flex justifyContent="space-between" alignItems="center" mt="10px">
                <Button
                ...
                {data?.claimable && <Button
                  onClick={onPresentClaim}
                  disabled={(data.userData?.vested - data.userData?.claimed) <= 0}
                >
                  {t("Claim")}
                </Button>}
                {(Date.now() / 1000 <= data?.presaleEndTimestamp - 15 * 60) && (data.userData?.deposit > 0) && <Button
                ...
                {(data?.refundable || (data?.totalDepositedBalance < data?.softCap && Date.now() / 1000 > data?.presaleEndTimestamp)) && <Button
                  onClick={onPresentWithdraw}
                  disabled={data.userData?.deposit <= 0}
                >
                  {t("Withdraw")}
                </Button>}
          ...
          <StyledAppBody mt="16px">
            <Box p="20px">
              ...
              <Divider />
              {isBuyTokenReady && userDataLoaded && data.userData ? <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
