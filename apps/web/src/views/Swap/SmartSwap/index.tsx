...
import { Currency, CurrencyAmount, NATIVE, Trade, Percent } from '@pancakeswap/sdk'
import {
  ArrowDownIcon,
  Box,
  Button,
...
export const SmartSwapForm: React.FC<{ handleOutputSelect: (newCurrencyOutput: Currency) => void }> = ({
  ...
  } = useDerivedSwapInfoWithStableSwap(independentField, typedValue, inputCurrency ?? undefined, outputCurrency ?? undefined, recipient)
  ...
  return (
    <>
      ...
      <Wrapper id="swap-page" style={{ minHeight: '412px' }}>
        <AutoColumn gap="sm">
          <div style={{ background: '#191919', borderRadius: '16px' }}>
            <CurrencyInputPanel
          ...
          <AutoColumn justify="space-between">
            <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ position: 'absolute', zIndex: '1', marginTop: '-20px', width: '92%' }}>
              <SwapUI.SwitchButton
                onClick={() => {
                  setApprovalSubmitted(false) // reset 2 step UI for approvals
                  onSwitchTokens()
                ...
                style={{ border: '2px solid #3c3c3c', borderRadius: '40px', background: '#333333', width: '36px', height: '36px' }}
              />
          ...
          <div style={{ background: '#353535', borderRadius: '16px' }}>
            <CurrencyInputPanel
