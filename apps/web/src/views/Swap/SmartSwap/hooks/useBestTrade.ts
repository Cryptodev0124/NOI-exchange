...
import { CurrencyAmount, TradeType, Currency, Pair, ChainId } from '@pancakeswap/sdk'
...
export const useBestTradeFromChain = createUseBestTrade(
  ...
  async ({ amount, currency, tradeType, allCommonPairs, maxHops }) => {
    ...
    const provider = ({chainId}: {chainId?: ChainId}) => viemClients[chainId ?? ChainId.BSC]
