...
import { ArrowBackIcon, ArrowForwardIcon, Button, Flex, NextLinkFromReactRouter, Text } from "@pancakeswap/uikit";
    ...
    <ResponsiveGrid>
      <Flex alignItems="center">
        ...
        <Flex flexDirection="column" ml="10px">
          <Text bold>{type !== 2 ? data.name : `${data.token0Name} / ${data.token1Name}`}</Text>
          <Text>{type !== 2 ? data.name : `${data.token0Symbol} / ${data.token1Symbol}`}</Text>
        </Flex>
      </Flex>
