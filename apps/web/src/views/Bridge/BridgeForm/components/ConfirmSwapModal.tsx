...
import TransactionConfirmSwapContentWithSmartRouter from 'views/Swap/SmartSwap/components/TransactionConfirmSwapContent'
    ...
    <TransactionErrorContent
      message={
        <>
          ...
          <LinkExternal
            href="https://docs.cyberglow.finance/cyberglow-dex/exchange"
...
const ConfirmBridgeModal: React.FC<React.PropsWithChildren<InjectedModalProps & ConfirmSwapModalProps>> = ({
  trade,
  originalTrade,
  currencyBalances,
  onAcceptChanges,
