  ...
  const steps2: Step[] = [
    {
      ...
      title: vault ? `${new BigNumber(vault?.stakingRebase || 0).times(100).toNumber().toLocaleString()} %` : '',
    },
    {
  ...
  const steps3: Step[] = [
    {
      ...
      title: userDataLoaded ? `${new BigNumber(vault?.userData?.dcp.balance ?? 0).div(BIG_TEN.pow(9)).toNumber().toLocaleString()} DCP` : '',
    },
    {
      label: t('Your SDCP Balance'),
      title: userDataLoaded ? `${Number(vault?.userData?.sdcp.balance ?? 0).toLocaleString()} USD` : '',
    },
    {
      label: t('Next Reward Amount'),
      title: userDataLoaded ? `${new BigNumber(vault?.userData?.sdcp.balance ?? 0).times(vault?.stakingRebase ?? 0).toNumber().toLocaleString()} SDCP` : '',
    },
  ]
