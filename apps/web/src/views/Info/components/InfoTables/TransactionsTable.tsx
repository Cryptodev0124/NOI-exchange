...
const DataRow: React.FC<React.PropsWithChildren<{ transaction: Transaction }>> = ({ transaction }) => {
  ...
  return (
    <ResponsiveGrid>
      <LinkExternal
        isBscScan
        href={getBlockExploreLink(transaction.hash, 'transaction', chainName === 'ETH' ? ChainId.ETHEREUM : undefined)}
      >
        <Text>
      ...
      <LinkExternal
        isBscScan
        href={getBlockExploreLink(transaction.sender, 'address', chainName === 'ETH' ? ChainId.ETHEREUM : undefined)}
      >
