      ...
      <FormContainer>
        ...
        <Box>
          ...
          <Box mb="20px">
            ...
            {/* <Box mt="10px">
              <Text color="text" fontSize="14px">{t("Enter the percentage of raised funds that should be allocated to Liquidity on CyberGlow (Min 51%, Max 100%)")}</Text>
              <Text color="text" fontSize="14px">{t("If I spend 1 %symbol% on how many tokens will I receive? Usually this amount is lower than presale rate to allow for a higher listing price on CyberGlow", {symbol: tokenData.currency.symbol})}</Text>
            </Box> */}
          </Box>
          <Box mb="20px">
