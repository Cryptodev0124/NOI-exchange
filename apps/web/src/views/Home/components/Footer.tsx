...
import BunnyImg from '../../../../public/images/home/planet.png'
import BunnyImg1 from '../../../../public/images/home/planet1.png'
  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        {!account && <ConnectWalletButton mt="24px" variant="primary" />}
      </Wrapper>
    </>
  )
}
