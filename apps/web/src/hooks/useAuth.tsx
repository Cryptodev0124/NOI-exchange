...
import { ConnectorNotFoundError, SwitchChainNotSupportedError, useConnect, useDisconnect, useAccount } from 'wagmi'
import { bloomConnector } from 'utils/wagmi'
...
const useAuth = () => {
  ...
  const login = useCallback(
    async (connectorID: ConnectorNames) => {
      // let findConnector = connectors.find((c) => c.id === connectorID)
      const findConnector = connectorID === ConnectorNames.Bloom ? bloomConnector : connectors.find((c) => c.id === connectorID)
      try {
