...
export default function CommonBases({
  ...
  const FIRST_LINE = chainId ? [SUGGESTED_BASES[chainId][0], SUGGESTED_BASES[chainId][1], SUGGESTED_BASES[chainId][2]] : []
  const SECOND_LINE_ETH = chainId ? [SUGGESTED_BASES[chainId][3]] : []
