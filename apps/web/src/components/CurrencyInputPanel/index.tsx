...
export default function CurrencyInputPanel({
  ...
  return (
    <Container position="relative" id={id} padding="15px">
      <Flex alignItems="center" justifyContent="space-between">
        <Flex flexDirection="column">
          <p style={{ display: "flex", alignItems: "center" }}>{label}</p>
          {/* {beforeButton} */}
          <div style={{ display: 'flex', flexDirection: 'row', paddingTop: '8px', paddingBottom: '5px' }}>
            ...
            >
              <Flex alignItems="center" justifyContent="space-between">
                ...
                {pair ? (
                  <Text id="pair" bold fontStyle="italic" fontFamily="Bigshot One" fontSize="20px">
