...
const Container = styled(Flex)`
  ...
  background: linear-gradient(0deg, rgba(39, 38, 44, 0.4), rgba(39, 38, 44, 0.4)),
    linear-gradient(180deg, rgb(81, 214, 198) 0%, rgb(34, 134, 110) 100%);
  ${({ theme }) => theme.mediaQueries.md} {
    padding: 0px;
    background: linear-gradient(180deg, rgb(81, 214, 198) 0%, rgb(34, 134, 110) 100%);
  }
`
...
const domain = 'https://cyberglow.finance'
...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    ...
    return warningText.split(/(https:\/\/kronoswap.finance)/g)
  }, [t])
