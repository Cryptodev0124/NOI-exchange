...
const ModalInputForLaunchpad: React.FC<React.PropsWithChildren<ModalInputProps>> = ({
  max,
  maxAmount,
  symbol,
  onChange,
    ...
    <div style={{ position: "relative", marginBottom: "20px" }}>
      <StyledTokenInput isWarning={isBalanceZero}>
        <Flex justifyContent="space-between" pl="16px">
          ...
          <Text fontSize="14px">{t("Max: %balance%", { balance: displayBalance(max) })}</Text>
        </Flex>
...
export default ModalInputForLaunchpad;
