...
const Logo: React.FC<React.PropsWithChildren<Props>> = ({ isHome = false, isPushed = false, togglePush, isDark, href }) => {
  ...
  return (
    <Flex alignItems="center">
      ...
      {!isHome && <MenuButton aria-label="Toggle menu" onClick={togglePush} ml="24px">
        {isPushed ? (
